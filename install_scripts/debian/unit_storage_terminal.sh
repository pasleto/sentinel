...
# /opt/sentinel/install/sentinel-storage-terminal/flutter-pi-engine-binaries
...
# /opt/sentinel/install/sentinel-storage-terminal/flutter-pi
...
if [ -f "/etc/rpi-issue" ]; then # this is raspberry pi os # TODO
