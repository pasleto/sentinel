...
class MacAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      //                 child: Image.asset('assets/icons/sentinel_icon_header.png', filterQuality: FilterQuality.high),
      //               ),
      //               Padding(
      //                 padding: const EdgeInsets.only(top: 7.0, bottom: 7.0),
      //                 child: Image.asset('assets/images/sentinel_header.png', filterQuality: FilterQuality.high),
      //               ),
      //             ],
      //           ),
      //           // child: Padding(
