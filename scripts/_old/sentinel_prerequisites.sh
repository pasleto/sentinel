...
# ================================================================
# Sentinel Install Prerequisites Script
# ================================================================
...
info "------------------------------------------------------------"
info "Sentinel Install Prerequisites Script"
info "------------------------------------------------------------"
if [ $(id -u) -ne 0 ]; then
...
info "Changing default user password to custom password ..."
echo -e "${NEW_PASS}\n${NEW_PASS}\n" | passwd ${DEFAULT_USER}
...
if [ $? -eq 0 ]; then
  ...
  info "Changing user sentinel password to custom password ..."
  echo -e "${NEW_PASS}\n${NEW_PASS}\n" | passwd ${NEW_USER}
...
info "------------------------------------------------------------"
info "Sentinel Install Prerequisites Done"
info "New user account:  ${NEW_USER}  /  ${NEW_PASS}"
