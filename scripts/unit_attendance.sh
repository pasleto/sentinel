...
HOSTNAME_PREFIX="SENTINEL-ATTENDANCE"
CURRENT_USER=sentinel



# ================================================================
# Sentinel Attendance Unit Install Script
# ================================================================
...
info "------------------------------------------------------------"
info "Sentinel - Attendance Unit Install Script"
info "------------------------------------------------------------"
...
info "Starting Attendance Unit Install Script"



# TODO - install sentinel attendance unit application
...
info "------------------------------------------------------------"
info "Attendance Unit Install Script Finished"
info "XXX"
