...
//           children: <Widget>[
//             Text('$name is installing.', style: Theme.of(context).textTheme.headlineMedium),
//             Container(height: 10),
//             Text('$name is a deferred component which are downloaded and installed at runtime.', style: Theme.of(context).textTheme.bodyLarge),
//             Container(height: 20),
