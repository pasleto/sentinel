...
4   -   lock 1 - button 1 - lock 1 request exit
  TODO 5   -   lock 1 - reader 2 - lock 1 request exit
  TODO 6   -   lock 1 - button 2 - lock 1 request entry
...
6   -   reader - entry - error (card not in database)
  TODO 7   -   reader - exit - success (card in database)
  TODO 8   -   reader - exit - error (card not in database)
  TODO 9   -   button - entry
...
void readerBuzzerOn(int initiator_id) {
  switch (initiator_id) {
    case 3:
      if (!silent_mode_1 && wg_1_1_connected) digitalWrite(ESP_WG_1_1_BUZZER, LOW); // ON
      break;
    // case 5:
    //   break;
    default:
...
void readerBuzzerOff(int initiator_id) {
  switch (initiator_id) {
    case 3:
      if (!silent_mode_1 && wg_1_1_connected) digitalWrite(ESP_WG_1_1_BUZZER, HIGH); // OFF
      break;
    // case 5:
    //   break;
    default:
...
void readerRedLedOn(int initiator_id) {
  switch (initiator_id) {
    case 3:
      if (wg_1_1_connected) digitalWrite(ESP_WG_1_1_RED_LED, LOW); // ON
      break;
    // case 5:
    //   break;
    default:
...
void readerRedLedOff(int initiator_id) {
  switch (initiator_id) {
    case 3:
      if (wg_1_1_connected) digitalWrite(ESP_WG_1_1_RED_LED, HIGH); // OFF
      break;
    // case 5:
    //   break;
    default:
...
void readerGreenLedOn(int initiator_id) {
  switch (initiator_id) {
    case 3:
      if (wg_1_1_connected) digitalWrite(ESP_WG_1_1_GREEN_LED, LOW); // ON
      break;
    // case 5:
    //   break;
    default:
...
void readerGreenLedOff(int initiator_id) {
  switch (initiator_id) {
    case 3:
      if (wg_1_1_connected) digitalWrite(ESP_WG_1_1_GREEN_LED, HIGH); // OFF
      break;
    // case 5:
    //   break;
    default:
...
void setupEspPins() {
  ...
  pinMode(ESP_WG_1_1_GREEN_LED, OUTPUT);
  digitalWrite(ESP_WG_1_1_GREEN_LED, LOW); // ON
  pinMode(ESP_WG_1_1_RED_LED, OUTPUT);
  digitalWrite(ESP_WG_1_1_RED_LED, LOW); // ON
  pinMode(ESP_WG_1_1_BUZZER, OUTPUT);
  digitalWrite(ESP_WG_1_1_BUZZER, HIGH); // OFF
...
void loop() { // This is Core 1
  if (is_setup_done) {
    ...
    digitalWrite(ESP_WG_1_1_GREEN_LED, HIGH); // OFF
    delay(500);
    digitalWrite(ESP_WG_1_1_GREEN_LED, LOW); // ON
    delay(500);
  }
